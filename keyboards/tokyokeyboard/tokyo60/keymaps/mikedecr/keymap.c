...
[BL] = LAYOUT_60_hhkb(
        ...
        KC_LSFT,            KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M, KC_COMM,  KC_DOT, KC_SLSH,      KC_RSFT, MO(FN),
             KC_LALT, KC_LCTL,              LT(SPACEFN, KC_SPC),                         KC_RGUI, KC_RALT ),
    /* 1: HHKB Fn layer
┌─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┐
...
[FN] = LAYOUT_60_hhkb(
       ...
       KC_ESC, RGB_TOG, RGB_MOD, RGB_RMOD, BL_TOGG, BL_STEP, KC_TRNS, KC_HOME, KC_UP,   KC_END, KC_MINS, KC_PAUS, KC_TRNS, KC_DEL,
       KC_TRNS, KC_VOLD, KC_VOLU, KC_MUTE,  KC_EJCT, KC_TRNS, KC_PGUP, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS,  KC_TRNS,           KC_PENT,
       KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS, KC_EQL, KC_TRNS, KC_PGDN,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS, KC_CAPS,
