...
[BL] = LAYOUT_60_hhkb(
        ...
        LCTL_T(KC_ESC),  KC_A,    KC_S,   KC_D,   LT(FN, KC_F),   KC_G,   KC_H,   KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT, RGUI_T(KC_ENT),
        LSFT_T(KC_EQL),            KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M, KC_COMM,  KC_DOT, KC_SLSH,      KC_RSFT, MO(FN),
             KC_LALT, LGUI_T(KC_EQL),              LT(SPACEFN, KC_SPC),                         KC_LGUI, KC_RALT ),
    /* 1: HHKB Fn layer
┌─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┐
...
[SPACEFN] = LAYOUT_60_hhkb(
        KC_TRNS,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,   KC_F8,     KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_INS,  KC_TRNS,
        KC_TRNS,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_TRNS,  KC_TRNS,  KC_DEL,
        KC_TRNS,  KC_VOLD,  KC_VOLU,  KC_MUTE,  KC_EJCT,  KC_HOME,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_MINS,  KC_TRNS,  KC_PENT,
        // KC_ESC, RGB_TOG, RGB_MOD, RGB_RMOD, BL_TOGG, BL_STEP, KC_TRNS, KC_HOME, KC_TRNS,   KC_END, KC_MINS, KC_PAUS, KC_TRNS, KC_DEL,
        KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS, KC_EQL,  KC_END,  KC_PGUP, KC_PGDN,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_CAPS,
             KC_TRNS, KC_TRNS,                   KC_TRNS,                         KC_TRNS, KC_TRNS
     ),
