...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    BACKLIT,         KC_LCTL, KC_LALT, KC_LGUI, LT(LOWER, KC_EQL),  _______,  LT(_SPACEFN, KC_SPC),   LT(RAISE, KC_MINS),   KC_LEFT, KC_DOWN, KC_UP,   KC_ENT
),

[_SPACEFN] = LAYOUT_planck_grid(
    KC_TRNS,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_BSPC,
    KC_TRNS,  KC_LPRN,  KC_TRNS,  KC_TRNS,  KC_RPRN,  KC_HOME,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_TRNS,  KC_ENT,
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  KC_TRNS, KC_TRNS, KC_TRNS,  _______,
