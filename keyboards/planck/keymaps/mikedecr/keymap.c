...
[_QWERTY] = LAYOUT_planck_grid(
    // might want some modifier here
    KC_TAB,  KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
    LCTL_T(KC_ESC),  KC_A,    KC_S,    KC_D,    LT(_SPACEFN, KC_F),  KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_LSFT,         KC_Z,    KC_X,    KC_C,    KC_V,                KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    BACKLIT,         KC_LCTL, KC_LALT, KC_LGUI, LT(LOWER, KC_EQL),  _______,  LT(_SPACEFN, KC_SPC),   LT(RAISE, KC_MINS),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),

[_SPACEFN] = LAYOUT_planck_grid(
    KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_BSPC,
    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_HOME,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_TRNS,  KC_TRNS,
